...
[구성]
1) 오프닝(10초): 오늘의 결론 한 줄
2) 문제 상황(30초): 시니어가 겪는 실제 상황 3개
3) 왜 아픈가(60초): 무릎 통증 원인 3가지 (각 3~4문장)
4) 원리 1(90초): 걷기 자세 핵심 1 (예시 포함)
5) 원리 2(90초): 걷기 자세 핵심 2 (예시 포함)
6) 원리 3(90초): 걷기 자세 핵심 3 (예시 포함)
7) 체크리스트(60초): 바로 확인 5가지 (한 줄씩)
8) 실전 루틴(120초): 7일 루틴 (1일 1줄)
9) 흔한 실수(60초): 실수 6개 (한 줄씩)
10) 통증 있을 때 대처(60초): 상황별 4개 (한 줄씩)
11) Q&A(60초): 자주 묻는 질문 5개 (Q/A 한 줄씩)
12) 결론(20초): 오늘 할 행동 1개 + 격려 한 문장
